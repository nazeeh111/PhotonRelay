...
export const messages: Messages = {
  ...
  home: {
    title: "PhotonRelay — trasferisci file con la luce",
    metaDescription:
    ...
    ogDescription: "Invia un file o un testo tra due dispositivi con soltanto uno schermo e una fotocamera. Codici QR animati con codifica fountain, nessun percorso di rete in mezzo.",
    ...
    shareSite: "Condividi PhotonRelay",
    supportTitle: "Gratuito, open source, senza pubblicità",
    supportBodyHtml:
      'Se PhotonRelay ti ha semplificato la giornata, puoi <a href="https://buymeacoffee.com/bashalarmist" target="_blank" rel="noopener noreferrer">offrirmi un caffè</a>.',
  ...
  send: {
    ...
    shareTitleData: "PhotonRelay — ricevitore",
  ...
  receive: {
    docTitle: "PhotonRelay — ricezione",
    ...
    clearCache: "Svuota la cache di PhotonRelay",
  ...
  verdicts: {
    olderSender: (version) =>
      `Quello schermo trasmette un formato PhotonRelay più vecchio (v${version}). Aggiorna il dispositivo che invia.`,
    newerSender: (version) =>
      `Quello schermo trasmette un formato PhotonRelay più recente (v${version}). Aggiorna questa app per riceverlo.`,
    unsupportedFlags:
      "Quel flusso usa una funzionalità di PhotonRelay che questa versione non sa leggere. Aggiorna questa app per riceverlo.",
  },
  ...
  i18n: {
    ...
    switchOffer: "PhotonRelay è disponibile in italiano.",
