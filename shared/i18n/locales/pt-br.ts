...
export const messages: Messages = {
  ...
  home: {
    title: "PhotonRelay — transfira arquivos com luz",
    metaDescription:
    ...
    ogDescription: "Envie um arquivo ou texto entre dois dispositivos usando apenas uma tela e uma câmera. Códigos QR animados com codificação fountain, sem nenhum caminho de rede no meio.",
    ...
    shareSite: "Compartilhar o PhotonRelay",
    supportTitle: "Gratuito, código aberto, sem anúncios",
    supportBodyHtml:
      'Se o PhotonRelay facilitou o seu dia, você pode <a href="https://buymeacoffee.com/bashalarmist" target="_blank" rel="noopener noreferrer">me pagar um café</a>.',
  ...
  receive: {
    ...
    clearCache: "Limpar cache do PhotonRelay",
  ...
  verdicts: {
    olderSender: (version) =>
      `Aquela tela está enviando um formato PhotonRelay mais antigo (v${version}). Atualize o dispositivo de envio.`,
    newerSender: (version) =>
      `Aquela tela está enviando um formato PhotonRelay mais novo (v${version}). Atualize este app para recebê-lo.`,
    unsupportedFlags:
      "Esse fluxo usa um recurso do PhotonRelay que esta versão não consegue ler. Atualize este app para recebê-lo.",
  },
  ...
  i18n: {
    ...
    switchOffer: "O PhotonRelay está disponível em português.",
