...
export const messages: Messages = {
  ...
  home: {
    title: "PhotonRelay — Dateien mit Licht übertragen",
    metaDescription:
    ...
    ogDescription: "Senden Sie eine Datei oder Text zwischen zwei Geräten — nur mit Bildschirm und Kamera. Fountain-codierte animierte QR-Codes, ganz ohne Netzwerkverbindung dazwischen.",
    ...
    shareSite: "PhotonRelay teilen",
    supportTitle: "Kostenlos, Open Source, ohne Werbung",
    supportBodyHtml:
      'Wenn PhotonRelay Ihnen den Tag leichter gemacht hat, können Sie mir <a href="https://buymeacoffee.com/bashalarmist" target="_blank" rel="noopener noreferrer">einen Kaffee spendieren</a>.',
  ...
  send: {
    ...
    shareTitleData: "PhotonRelay — Empfänger",
  ...
  receive: {
    docTitle: "PhotonRelay — Empfangen",
    ...
    clearCache: "PhotonRelay-Cache leeren",
  ...
  verdicts: {
    olderSender: (version) =>
      `Dieser Bildschirm sendet ein älteres PhotonRelay-Format (v${version}). Aktualisieren Sie das sendende Gerät.`,
    newerSender: (version) =>
      `Dieser Bildschirm sendet ein neueres PhotonRelay-Format (v${version}). Aktualisieren Sie diese App, um es zu empfangen.`,
    unsupportedFlags:
      "Dieser Stream nutzt eine PhotonRelay-Funktion, die diese Version nicht lesen kann. Aktualisieren Sie diese App, um ihn zu empfangen.",
  },
  ...
  i18n: {
    ...
    switchOffer: "PhotonRelay ist auf Deutsch verfügbar.",
