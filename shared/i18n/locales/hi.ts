...
export const messages: Messages = {
  ...
  home: {
    title: "PhotonRelay — रोशनी से फ़ाइलें ट्रांसफ़र करें",
    metaDescription:
    ...
    ogDescription: "सिर्फ़ एक स्क्रीन और एक कैमरे से दो डिवाइस के बीच फ़ाइल या टेक्स्ट भेजें। फ़ाउंटेन-कोडेड एनिमेटेड QR कोड — बीच में कोई नेटवर्क नहीं।",
    ...
    shareSite: "PhotonRelay शेयर करें",
    supportTitle: "मुफ़्त, ओपन सोर्स, बिना विज्ञापन",
    supportBodyHtml:
      'अगर PhotonRelay ने आपका काम आसान किया हो, तो आप <a href="https://buymeacoffee.com/bashalarmist" target="_blank" rel="noopener noreferrer">मुझे एक कॉफ़ी पिला सकते हैं</a>।',
  ...
  send: {
    ...
    shareTitleData: "PhotonRelay — रिसीवर",
  ...
  receive: {
    docTitle: "PhotonRelay — प्राप्त करें",
    ...
    clearCache: "PhotonRelay कैश साफ़ करें",
  ...
  verdicts: {
    olderSender: (version) =>
      `वह स्क्रीन पुराना PhotonRelay फ़ॉर्मैट (v${version}) भेज रही है। भेजने वाले डिवाइस को अपडेट करें।`,
    newerSender: (version) =>
      `वह स्क्रीन नया PhotonRelay फ़ॉर्मैट (v${version}) भेज रही है। इसे प्राप्त करने के लिए यह ऐप अपडेट करें।`,
    unsupportedFlags:
      "वह स्ट्रीम PhotonRelay की ऐसी सुविधा इस्तेमाल करती है जिसे यह वर्शन नहीं पढ़ सकता। इसे प्राप्त करने के लिए यह ऐप अपडेट करें।",
  },
  ...
  i18n: {
    ...
    switchOffer: "PhotonRelay हिन्दी में उपलब्ध है।",
