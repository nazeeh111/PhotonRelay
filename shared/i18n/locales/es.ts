...
export const messages: Messages = {
  ...
  home: {
    title: "PhotonRelay — transferir archivos con luz",
    metaDescription:
    ...
    ogDescription: "Envíe un archivo o texto entre dos dispositivos con nada más que una pantalla y una cámara. Códigos QR animados con codificación fountain, sin ruta de red de por medio.",
    ...
    shareSite: "Compartir PhotonRelay",
    supportTitle: "Gratis, de código abierto, sin anuncios",
    supportBodyHtml:
      'Si PhotonRelay le facilitó el día, puede <a href="https://buymeacoffee.com/bashalarmist" target="_blank" rel="noopener noreferrer">invitarme un café</a>.',
  ...
  send: {
    ...
    shareTitleData: "PhotonRelay — receptor",
  ...
  receive: {
    ...
    clearCache: "Borrar caché de PhotonRelay",
  ...
  verdicts: {
    olderSender: (version) =>
      `Esa pantalla está enviando un formato PhotonRelay más antiguo (v${version}). Actualice el dispositivo emisor.`,
    newerSender: (version) =>
      `Esa pantalla está enviando un formato PhotonRelay más nuevo (v${version}). Actualice esta aplicación para recibirlo.`,
    unsupportedFlags:
      "Esa transmisión usa una función de PhotonRelay que esta versión no puede leer. Actualice esta aplicación para recibirla.",
  },
  ...
  i18n: {
    ...
    switchOffer: "PhotonRelay está disponible en español.",
