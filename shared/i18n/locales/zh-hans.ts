...
export const messages: Messages = {
  ...
  home: {
    title: "PhotonRelay — 用光传输文件",
    metaDescription:
      "只用一块屏幕和一个摄像头，就能在两台设备之间发送文件或文本。喷泉码动态二维码，中间没有任何网络链路。",
    ogDescription: "只用一块屏幕和一个摄像头，就能在两台设备之间发送文件或文本。喷泉码动态二维码，中间没有任何网络链路。",
    ...
    shareSite: "分享 PhotonRelay",
    supportTitle: "免费、开源、无广告",
    supportBodyHtml:
      '如果 PhotonRelay 帮到了你，欢迎<a href="https://buymeacoffee.com/bashalarmist" target="_blank" rel="noopener noreferrer">请我喝杯咖啡</a>。',
  ...
  send: {
    ...
    shareTitleData: "PhotonRelay — 接收器",
  ...
  verdicts: {
    olderSender: (version) =>
      `对方屏幕正在以较旧的 PhotonRelay 格式（v${version}）发送。请更新发送设备。`,
    newerSender: (version) =>
      `对方屏幕正在以较新的 PhotonRelay 格式（v${version}）发送。请更新本应用后再接收。`,
    unsupportedFlags: "该数据流使用了此版本无法读取的 PhotonRelay 功能。请更新本应用后再接收。",
  },
  ...
  i18n: {
    ...
    switchOffer: "PhotonRelay 提供简体中文版。",
