...
export const messages: Messages = {
  ...
  home: {
    title: "PhotonRelay — transférer des fichiers par la lumière",
    metaDescription:
    ...
    ogDescription: "Envoyez un fichier ou du texte entre deux appareils avec rien d’autre qu’un écran et une caméra. Des codes QR animés à codage fontaine, sans aucun chemin réseau entre les deux.",
    ...
    shareSite: "Partager PhotonRelay",
    supportTitle: "Gratuit, open source, sans publicité",
    supportBodyHtml:
      'Si PhotonRelay vous a facilité la vie, vous pouvez <a href="https://buymeacoffee.com/bashalarmist" target="_blank" rel="noopener noreferrer">m’offrir un café</a>.',
  ...
  send: {
    ...
    shareTitleData: "PhotonRelay — récepteur",
  ...
  receive: {
    ...
    clearCache: "Vider le cache PhotonRelay",
  ...
  verdicts: {
    olderSender: (version) =>
      `Cet écran envoie un format PhotonRelay plus ancien (v${version}). Mettez à jour ` +
      `l’appareil émetteur.`,
    newerSender: (version) =>
      `Cet écran envoie un format PhotonRelay plus récent (v${version}). Mettez à jour ` +
      `cette application pour le recevoir.`,
    unsupportedFlags:
      "Ce flux utilise une fonctionnalité PhotonRelay que cette version ne sait pas lire. " +
  ...
  i18n: {
    ...
    switchOffer: "PhotonRelay est disponible en français.",
