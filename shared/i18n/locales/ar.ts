...
export const messages: Messages = {
  ...
  home: {
    title: "PhotonRelay — نقل الملفات بالضوء",
    metaDescription:
      "أرسل ملفًا أو نصًا بين جهازين دون أي شيء سوى شاشة وكاميرا. رموز QR متحركة بترميز النافورة، من دون أي مسار شبكي بينهما.",
    ogDescription: "أرسل ملفًا أو نصًا بين جهازين دون أي شيء سوى شاشة وكاميرا. رموز QR متحركة بترميز النافورة، من دون أي مسار شبكي بينهما.",
    ...
    shareSite: "مشاركة PhotonRelay",
    supportTitle: "مجاني ومفتوح المصدر وبلا إعلانات",
    supportBodyHtml:
      'إذا جعل PhotonRelay يومك أسهل، يمكنك أن <a href="https://buymeacoffee.com/bashalarmist" target="_blank" rel="noopener noreferrer">تشتري لي فنجان قهوة</a>.',
  ...
  send: {
    ...
    shareTitleData: "PhotonRelay — المستقبِل",
  ...
  receive: {
    docTitle: "PhotonRelay — الاستقبال",
    ...
    clearCache: "مسح ذاكرة PhotonRelay المؤقتة",
  ...
  verdicts: {
    olderSender: (version) =>
      `تلك الشاشة ترسل بتنسيق PhotonRelay أقدم (v${version}). حدِّث الجهاز المرسِل.`,
    newerSender: (version) =>
      `تلك الشاشة ترسل بتنسيق PhotonRelay أحدث (v${version}). حدِّث هذا التطبيق لاستقباله.`,
    unsupportedFlags:
      "يستخدم هذا البث ميزة من PhotonRelay لا يستطيع هذا الإصدار قراءتها. حدِّث هذا التطبيق لاستقباله.",
  },
  ...
  i18n: {
    ...
    switchOffer: "يتوفر PhotonRelay باللغة العربية.",
